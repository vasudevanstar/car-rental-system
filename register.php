...
<head>
  ...
  <style>
    ...
    @keyframes pulseShadow {
      0% { box-shadow: 0 0 0 0 rgba(255, 188, 56, 0.5); }
      70% { box-shadow: 0 0 0 12px rgba(255, 188, 56, 0); }
      100% { box-shadow: 0 0 0 0 rgba(255, 188, 56, 0); }
    }
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .green-bg-shape {
      ...
      width: 35%;
      height: 100%;
      background: linear-gradient(180deg, #95d4a1 0%, #17a085 100%);
      z-index: 1;
      opacity: 0;
    ...
    .car-image-container {
      ...
      pointer-events: none;
      opacity: 0;
      animation: carEnter 1s cubic-bezier(0.2, 0.8, 0.2, 1) 0.4s forwards;
    }
    ...
    .login-box {
      ...
      min-height: 480px;
      opacity: 0;
      animation: slideUpCard 0.8s cubic-bezier(0.2, 0.8, 0.2, 1) 0.2s forwards;
    }
    .close-btn {
      position: absolute;
      top: 20px;
    ...
    .form-container { width: 55%; padding-left: 20px; display: flex; flex-direction: column; justify-content: center; }
    ...
    #registerForm { opacity: 0; animation: fadeInText 0.6s ease 0.8s forwards; }
    .input-group { margin-bottom: 15px; position: relative; }
    .input-field { width: 100%; padding: 12px 15px 12px 35px; border: 1px solid #e0e0e0; border-radius: 4px; font-size: 13px; color: #333; font-family: inherit; outline: none; transition: all 0.3s ease; background: #fafafa; }
    .input-field:focus { border-color: #ffbc38; background: #fff; transform: translateY(-2px); box-shadow: 0 5px 15px rgba(0, 0, 0, 0.05); }
    .input-icon { position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: #b0b0b0; font-size: 14px; pointer-events: none; transition: color 0.3s ease; z-index: 2; }
    .input-field:focus+.input-icon { color: #ffbc38; }
    ...
    .submit-btn:hover { background: #f0ae27; transform: translateY(-2px); box-shadow: 0 6px 15px rgba(255, 188, 56, 0.4); }
...
<body>
    ...
    <div class="login-card-wrapper">
      ...
      <div class="login-box">
        ...
        <div class="form-container">
          ...
          <p class="form-subtitle">Join us and experience the easiest way to rent a pristine vehicle for your journey.</p>

          <form id="registerForm">
            <div id="message" style="width: 100%; text-align: center; color: red;"></div>

            <div class="input-group">
              <input type="text" id="name" class="input-field" placeholder="Full Name" required autofocus>
            ...
            <button type="submit" class="submit-btn" id="registerBtn">Sign Up Now</button>
  ...
  <script>document.addEventListener('DOMContentLoaded', registerInit);</script>
</body>
