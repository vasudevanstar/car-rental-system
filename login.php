...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    #loginForm { opacity: 0; animation: fadeInText 0.6s ease 0.8s forwards; }
    ...
    .form-options { display: flex; justify-content: space-between; margin-top: 15px; font-size: 12px; }
    .opt-forgot { color: #999; text-decoration: none; transition: color 0.2s; }
...
<body>
    ...
    <div class="login-card-wrapper">
      ...
      <div class="login-box">
        ...
        <div class="form-container">
          ...
          <p class="form-subtitle">Since this is your first trip, you'll need to provide us<br>with some information before you can check out.</p>
          ...
          <form id="loginForm">
            ...
            <div class="form-options">
              <a href="#" class="opt-forgot" onclick="forgotPassword(event)">Forgot password?</a>
            </div>
  ...
  <script>
    ...
    // Fake toggle for script.js compatibility
    const fakeToggle = document.createElement('button');
    fakeToggle.id = 'togglePassword';
    fakeToggle.style.display = 'none';
    document.body.appendChild(fakeToggle);
  </script>
</body>
